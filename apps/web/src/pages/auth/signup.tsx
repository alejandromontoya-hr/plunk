...
export default function Signup() {
  ...
  async function onSubmit(values: z.infer<typeof AuthenticationSchemas.signup>) {
    try {
      ...
      if (!response.success) {
        const errorData = typeof response.data === 'string' ? response.data : t('auth.errors.somethingWentWrong');
  ...
  return (
    <>
      <NextSeo title={t('auth.signup.seoTitle')} />
      <div
                      ...
                      <FormField
                        ...
                        render={({field}) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder={t('auth.fields.passwordPlaceholder')} type="password" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
